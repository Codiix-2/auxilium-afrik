<?php if( ! $return): ?><div id="<?php echo $slug; ?>" class="smylesv2-card card ui segment"><?php endif; ?>
	<div id="<?php echo "{$slug}_dimmer"; ?>" class="ui dimmer">
		<div class="ui text loader"><?php _e( 'Activating ...', 'wp-job-manager-search-and-filtering' ); ?></div>
	</div>
	<div class="content smylesv2-card-top">
		<?php if( ! $plugin_installed ) echo "<a class=\"ui mini red top fluid attached label\">" . __( 'Plugin Not Found', 'wp-job-manager-search-and-filtering' ) . "</a>"; ?>
					...
					<div class="content">
						<div class="center">
							<a href="https://plugins.smyl.es/<?php echo $slug; ?>" target="_blank" class="ui icon inverted button smylesv2-button" style="height: auto;">
								...
								<?php _e('Details', 'wp-job-manager-search-and-filtering'); ?>
							</a>
						</div>
					</div>
				</div>
	...
	<div class="content">
		...
		<div class="meta">
			<?php if( ! empty( $version ) ): ?>
					<a class="ui mini basic icon label">
						...
						<?php _e('Installed Version:', 'wp-job-manager-search-and-filtering'); ?>
		...
		<div class="description">
			...
			<div id="<?php echo "{$slug}_license_key_wrap"; ?>" class="ui fluid large left icon input" style="margin-top: 10px; float: none !important;">
	...
	<button id="<?php echo $slug; ?>" class="activate-license ui bottom attached button olive" style="height: auto;" type="submit">
		...
		<?php _e('Activate License', 'wp-job-manager-search-and-filtering'); ?>
	</button>
