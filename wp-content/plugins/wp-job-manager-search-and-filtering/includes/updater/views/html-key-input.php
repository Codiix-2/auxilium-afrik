<tr id="<?php echo esc_attr( sanitize_title( $this->plugin_slug . '_licence_key_row' ) ); ?>" class="active plugin-update-tr smylesv2-updater-licence-key-tr">
	<td class="plugin-update" colspan="3">
		...
		<div class="smylesv2-updater-licence-key">
			<span><?php printf( __( '<a href="%1$s">Click here to activate your license key</a> in order to receive updates and support for this plugin.', 'wp-job-manager-search-and-filtering' ), admin_url( 'index.php?page=smyles-licenses' ) ); ?></span>
