...
<form method="GET" action="<?php echo esc_url( get_permalink( get_option( 'job_manager_jobs_page_id' ) ) ); ?>" class="job-search-form <?php echo esc_attr( $search_style ); ?>">
	<div class="search-keywords"><input type="text" id="search_keywords" name="search_keywords" placeholder="<?php esc_html_e( 'Keywords', 'cariera-core' ); ?>" autocomplete="off">
	...
	<?php if ( 'yes' === $location ) { ?>
		<div class="search-location">
			<input type="text" id="search_location" name="search_location" placeholder="<?php esc_html_e( 'Location', 'cariera-core' ); ?>">
	...
	<div class="search-submit">
		<input type="submit" class="btn btn-main btn-effect" value="<?php esc_html_e( 'Search', 'cariera-core' ); ?>">
	</div>
</form>
