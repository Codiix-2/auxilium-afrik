<?php
/**
 * Onboarding Importer - Uninstaller Success Popup
 *
 * This template can be overridden by copying it to cariera-child/cariera_core/backend/importer/popup-uninstall-success.php.
 *
 * @package     cariera
 * @category    Template
 * @since       1.9.8
...
<div id="import-success" class="cariera-success-wrapper">
	<div class="success-header">
		...
		<h4 class="popup-title"><?php esc_html_e( 'Uninstall Complete!', 'cariera-core' ); ?></h4>
		<p class="popup-subtitle"><?php esc_html_e( 'The demo content was successfully removed.', 'cariera-core' ); ?></p>
	</div>
