...
class Permalinks {
	...
	public function setup_fields() {
		add_settings_field(
			'company_base_slug',
			esc_html__( 'Company base', 'cariera-core' ),
		...
		add_settings_field(
			...
			esc_html__( 'Company category base', 'cariera-core' ),
		...
		add_settings_field(
			...
			esc_html__( 'Company archive page', 'cariera-core' ),
	...
	public function companies_archive_slug_input() {
		?>
		<input name="companies_archive_slug" type="text" class="regular-text code" value="<?php echo esc_attr( $this->permalinks['companies_archive'] ); ?>" placeholder="<?php echo esc_attr_x( 'companies', 'Companies archive permalink - resave permalinks after changing this', 'cariera-core' ); ?>" />
		<?php
	}
	...
	public function company_base_slug_input() {
		?>
		<input name="company_base_slug" type="text" class="regular-text code" value="<?php echo esc_attr( $this->permalinks['company_base'] ); ?>" placeholder="<?php echo esc_attr_x( 'company', 'Company permalink - resave permalinks after changing this', 'cariera-core' ); ?>" />
		<?php
	}
	...
	public function company_category_slug_input() {
		?>
		<input name="company_category_slug" type="text" class="regular-text code" value="<?php echo esc_attr( $this->permalinks['company_category'] ); ?>" placeholder="<?php echo esc_attr_x( 'company-category', 'Company category slug - resave permalinks after changing this', 'cariera-core' ); ?>" />
		<?php
	}
	...
	public function settings_save() {
		...
		update_option( \Cariera_Core\Core\Company_Manager\CPT::PERMALINK_OPTION_NAME, $permalink_settings );
