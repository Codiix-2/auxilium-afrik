...
class Taxonomy extends Job_Manager {
	...
	public function __construct() {
		...
		// Add field.
		add_action( 'job_listing_category_add_form_fields', [ $this, 'add_new_meta_field' ], 10, 2 );

		// Edit Field.
		add_action( 'job_listing_category_edit_form_fields', [ $this, 'edit_meta_field' ], 10, 2 );

		// Save field.
		add_action( 'create_job_listing_category', [ $this, 'save_taxonomy_custom_meta' ] );
		add_action( 'edited_job_listing_category', [ $this, 'save_taxonomy_custom_meta' ] );
	}
		...
		$taxonomies_args = apply_filters(
			...
			[
				'job_listing_career_level'  => [
					'singular' => esc_html__( 'Job Career Level', 'cariera-core' ),
					'plural'   => esc_html__( 'Job Career level', 'cariera-core' ),
					'slug'     => esc_html_x( 'job-career-level', 'Job career level permalink - resave permalinks after changing this', 'cariera-core' ),
					'enable'   => get_option( 'cariera_job_manager_enable_career_level', true ),
				],
				'job_listing_experience'    => [
					'singular' => esc_html__( 'Job Experience', 'cariera-core' ),
					'plural'   => esc_html__( 'Job Experience', 'cariera-core' ),
					'slug'     => esc_html_x( 'job-experience', 'Job experience permalink - resave permalinks after changing this', 'cariera-core' ),
					'enable'   => get_option( 'cariera_job_manager_enable_experience', true ),
				],
				'job_listing_qualification' => [
					'singular' => esc_html__( 'Job Qualification', 'cariera-core' ),
					'plural'   => esc_html__( 'Job Qualification', 'cariera-core' ),
					'slug'     => esc_html_x( 'job-qualification', 'Job qualification permalink - resave permalinks after changing this', 'cariera-core' ),
