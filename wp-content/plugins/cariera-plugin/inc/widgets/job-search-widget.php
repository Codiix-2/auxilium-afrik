...
class Cariera_Widget_Job_Search extends WP_Widget {
	...
	public function __construct() {
		$widget_options = [
			...
			'description' => esc_html__( 'Job search form.', 'cariera-core' ),
		];

		parent::__construct( 'job-search-widget', esc_html__( 'Custom: Job Search Widget', 'cariera-core' ), $widget_options, 'cariera-core' );
	}
