...
class Cariera_Widget_Company_Search extends WP_Widget {
	...
	public function __construct() {
		$widget_options = [
			...
			'description' => esc_html__( 'Company search form.', 'cariera-core' ),
		];

		parent::__construct( 'company-search-widget', esc_html__( 'Custom: Company Search Widget', 'cariera-core' ), $widget_options, 'cariera-core' );
	}
