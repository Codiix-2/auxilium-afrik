...
class Cariera_Resumes extends \Elementor\Widget_Base {
	...
	public function get_script_depends() {
		return [ 'cariera-addons-resume-ajax-filters' ];
	}
	...
	protected function render() {
		...
		if ( 'grid' === $settings['layout'] ) {
			$atts['resumes_layout'] = 'grid';

			if ( '1' !== $settings['grid_layout'] ) {
				$atts['resumes_grid_version'] = $settings['grid_layout'];
			}
		} elseif ( '1' !== $settings['list_layout'] ) {
			$atts['resumes_list_version'] = $settings['list_layout'];
		}
