...
class Cariera_Video_Popup extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Video Popup', 'cariera-core' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'link',
			[
				'label'         => esc_html__( 'Video Link', 'cariera-core' ),
		...
		$this->add_control(
			'overlay',
			[
				'label'   => esc_html__( 'Overlay Color', 'cariera-core' ),
		...
		$this->add_control(
			'open',
			[
				'label'   => esc_html__( 'Open Video in', 'cariera-core' ),
				'type'    => \Elementor\Controls_Manager::SELECT,
				'options' => [
					'popup'  => esc_html__( 'Popup', 'cariera-core' ),
					'window' => esc_html__( 'New Window', 'cariera-core' ),
				],
				'default' => 'popup',
			]
		);
