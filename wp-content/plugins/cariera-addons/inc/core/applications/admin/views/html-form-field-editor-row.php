...
<tr>
	...
	<td>
		<input type="text" class="input-text" name="field_description[<?php echo esc_attr( $index ); ?>]" value="<?php echo esc_attr( isset( $field['description'] ) ? $field['description'] : '' ); ?>" placeholder="<?php esc_attr_e( 'N/A', 'cariera-addons' ); ?>" />
	</td>
	<td class="field-options">
		<input type="text" class="input-text placeholder" name="field_placeholder[<?php echo esc_attr( $index ); ?>]" value="<?php echo esc_attr( isset( $field['placeholder'] ) ? $field['placeholder'] : '' ); ?>" placeholder="<?php esc_attr_e( 'N/A', 'cariera-addons' ); ?>" />

		<input type="text" class="input-text options" name="field_options[<?php echo esc_attr( $index ); ?>]" placeholder="<?php esc_attr_e( 'Pipe (|) separate options.', 'cariera-addons' ); ?>" value="<?php echo esc_attr( isset( $field['options'] ) ? implode( ' | ', $field['options'] ) : '' ); ?>" />

		<div class="file-options">
			<label class="multiple-files"><input type="checkbox" class="input-text" name="field_multiple_files[<?php echo esc_attr( $index ); ?>]" value="1" <?php checked( ! empty( $field['multiple'] ), true ); ?> /> <?php esc_attr_e( 'Multiple Files?', 'cariera-addons' ); ?></label>
		</div>
