 ...
 *
 * This template can be overridden by copying it to yourtheme/cariera-addons/alerts/emails/email-job-alert-jobs.php.
 *
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" role="presentation" style="border-spacing: 0; margin: 24px 0; width: 100%;">
	...
	foreach ( $jobs as $key => $job ) {
		...
		$logo_alt = sprintf( __( '%s logo', 'cariera-addons' ), $company );
