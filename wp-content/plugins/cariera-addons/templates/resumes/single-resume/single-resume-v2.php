<?php
/**
 * Single Resume Layout Version 2
 *
 * This template can be overridden by copying it to yourtheme/cariera-addons/resumes/single-resume/single-resume-v2.php.
 *
...
$resume_classes = [ 'single-resume-page', 'single-resume-v2' ];
