<?php
/**
 * Single Resume - Private Message
 *
 * This template can be overridden by copying it to yourtheme/cariera-addons/resumes/single-resume/private-message.php.
 *
...
<div class="resume-private-message">
	<?php if ( is_user_logged_in() ) { ?>
		...
		class="popup-with-zoom-anim btn btn-main listing-btn contact-listing-btn" 
		...
		data-user-id="1">
			<?php esc_html_e( 'Direct message', 'cariera-addons' ); ?>
		</a>
		<?php
	} else {
