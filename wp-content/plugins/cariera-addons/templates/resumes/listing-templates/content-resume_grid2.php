<?php
/**
 * Resume Listing - Grid Version 2
 *
 * This template can be overridden by copying it to yourtheme/cariera-addons/resumes/listing-templates/content-resume_grid2.php.
 *
...
$resume_class = 'resume-grid single_resume_2';
			...
			<div class="resume-details">
				...
				<?php if ( ! empty( get_the_candidate_location() ) ) { ?>
					<div class="resume-location">
						<span><i class="las la-map-marker"></i><?php echo the_candidate_location( false ); ?></span>
					</div>
				<?php } ?>
			</div>
		</a>
