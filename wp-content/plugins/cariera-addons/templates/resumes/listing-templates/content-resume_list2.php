<?php
/**
 * Resume Listing - List Version 2
 *
 * This template can be overridden by copying it to yourtheme/cariera-addons/resumes/listing-templates/content-resume_list2.php.
 *
		...
		<div class="resume-content-footer">
			<div class="resume-details">
				...
				if ( ! empty( $rate ) ) {
					?>
					<div class="rate">
						<h3 class="title"><?php esc_html_e( 'Rate', 'cariera-addons' ); ?></h3>
				...
				<?php if ( $category ) { ?>
					<div class="resume-category">
						<h3 class="title"><?php esc_html_e( 'Categories', 'cariera-addons' ); ?></h3>
