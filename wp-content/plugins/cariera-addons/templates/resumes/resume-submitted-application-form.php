<?php
/**
 * When users intend to apply for a job with a resume, this shows the application form at the end of the resume submission process.
 *
 * This template can be overridden by copying it to yourtheme/cariera-addons/resumes/resume-submitted-application-form.php.
 *
...
<h3 class="applying_for">
	...
	echo wp_kses_post( sprintf( __( 'Submit your application to the job "%s".', 'cariera-addons' ), '<a href="' . get_permalink( $job_id ) . '">' . get_the_title( $job_id ) . '</a>' ) );
	?>
</h3>
<?php
