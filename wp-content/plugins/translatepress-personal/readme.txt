...
== Changelog ==
= 1.6.8 =
* Changed location of license checker function
* Added different wording for the License page

= 1.6.7 =
* Added the plugin updater code from TranslatePress - Multilingual into this plugin

= 1.6.6 =
* Fix Yoast/RankMath/SEOPress sitemaps showing untranslated slugs on secondary domains when Different Domain per Language is enabled

= 1.6.5 =
* Fixed issue regarding inserting translated slugs as originals. Prevent attachment slugs from being machine translated

= 1.6.4 =
* Added support for automatically translating hierarchical slugs like page-parent/page-child or WooCommerce slugs like product/category-parent/category-child/product-name
* Fixed redirect loop for composite WooCommerce base. Display composite WooCommerce base in the string translation editor
* Fixed WooCommerce redirect loop on product category pages
...
= 1.6 =
* Added support for the new Pro add-on: Different Domain for Language
...
= 1.5.8 =
* Fixed Pro addons being shown as active for Personal license
...
* Fix PHP warnings in gettext slug translations
...
* Added filter to allow disabling translation of slugs of type other
