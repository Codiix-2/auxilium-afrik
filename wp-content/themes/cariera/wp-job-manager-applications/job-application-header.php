...
<ul class="meta">
	...
	<?php if ( $email ) { ?>
		...
		<li class="email"><a href="mailto:<?php echo esc_attr( $email ); ?>?subject=<?php echo esc_attr( $email_subject ); ?>&amp;body=<?php echo esc_attr( $email_body ); ?>" title="<?php esc_attr_e( 'Email', 'cariera' ); ?>" class="job-application-contact"><i class="lar la-envelope"></i> <?php esc_html_e( 'Email', 'cariera' ); ?></a></li>
	<?php } ?>                                
	...
	if ( $resume_id && 'publish' === get_post_status( $resume_id ) && $resume_share_link ) {
		...
		<i class="las la-download" aria-hidden="true"></i><?php esc_html_e( 'View Resume', 'cariera' ); ?></a></li>
	<?php } ?>
</ul>
...
<ul class="actions">
	...
	<li class="edit">
		<a href="#" class="job-application-toggle-edit button"><i class="lar la-edit"></i><?php esc_html_e( 'Edit', 'cariera' ); ?></a>
	</li>
	<li class="notes <?php echo get_comments_number( $application->ID ) ? 'has-notes' : ''; ?>">
		<a href="#" class="job-application-toggle-notes button"><i class="las la-comments"></i><?php esc_html_e( 'Notes', 'cariera' ); ?></a>
	</li>
	<li class="content">
		<a href="#" class="job-application-toggle-content button"><i class="las la-info-circle"></i><?php esc_html_e( 'Details', 'cariera' ); ?></a>
	</li>
