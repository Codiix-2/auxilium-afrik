...
class Field_Editor {
	...
	public function custom_field_editor_auto_output( $output_options, $list_field_group ) {
		...
		$company_options = [
			...
			'cariera_single_company_title'          => esc_html__( 'Company Title Output', 'cariera' ),
		...
		$resume_options = [
			...
			'single_resume_title'                  => esc_html__( 'Resume Title Output', 'cariera' ),
