...
class Woocommerce {
	...
	public function __construct() {
		...
		// Disable WooCommerce setup wizard redirect.
	...
	public function shopping_cart_modal() {
		...
		get_template_part( 'templates/popups/shopping-cart' );
	}
	...
	public function remove_wc_actions() {
		...
		// Make sure Terms & Conditions link on checkout open on a new tab.
