<?php
/**
 * Custom: Taxonomy Template - Resume Category
 *
 * This template can be overridden by copying it to yourtheme/wp-job-manager-resumes/taxonomy-resume_category.php.
 *
