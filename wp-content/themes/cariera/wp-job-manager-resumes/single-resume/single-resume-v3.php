<?php
/**
 * Custom: Single Resume - Layout Version 3
 *
 * This template can be overridden by copying it to yourtheme/wp-job-manager-resumes/single-resume/single-resume-v3.php.
 *
