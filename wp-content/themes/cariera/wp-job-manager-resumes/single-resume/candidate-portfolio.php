<?php
/**
 * Custom: Candidate Portfolio
 *
 * This template can be overridden by copying it to yourtheme/wp-job-manager-resumes/single-resume/candidate-portfolio.php.
 *
...
<div id="candidate-portfolio" class="candidate-portfolio">
	<h2 class="content-title"><?php esc_html_e( 'Candidate Portfolio', 'cariera' ); ?></h2>
		...
		foreach ( $gallery as $attach_id => $img_url ) {
			...
			<div class="portfolio-item <?php echo esc_attr( $additional_class ); ?>">
				<a href="<?php echo esc_url( $img_url ); ?>" data-elementor-lightbox-slideshow="candidate-gallery" class="popup-image-gallery <?php echo esc_attr( $more_image_class ); ?>">
					<img src="<?php echo esc_attr( $img_url ); ?>" width="200" height="200" alt="<?php esc_attr_e( 'Candidate portfolio image.', 'cariera' ); ?>" />
				</a>
