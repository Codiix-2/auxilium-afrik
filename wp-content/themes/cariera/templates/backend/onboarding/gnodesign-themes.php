...
<h2 class="title"><?php esc_html_e( 'More Quality Themes', 'cariera' ); ?>
	<a href="https://1.envato.market/gnodesign" class="title-btn envato" target="_blank"><?php echo esc_html( 'Envato Portfolio' ); ?></a> 
</h2>
	...
	<?php foreach ( $themes as $theme ) { ?>
		<div class="product-item">
			<a href="<?php echo esc_url( $theme['link'] ); ?>" target="_blank">
				<div class="theme-img">
					<img src="<?php echo esc_url( $theme['bg-img'] ); ?>" alt="" lazy="loading">
