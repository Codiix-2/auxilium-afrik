...
<div class="meta-tags">
	...
	<?php if ( in_array( 'com', $metas, true ) ) { ?>
		<span class="comments"><i class="lar la-comment"></i><?php comments_number( esc_html__( '0 comments', 'cariera' ), esc_html__( '1 comment', 'cariera' ), esc_html__( '% comments', 'cariera' ) ); ?></span>
	<?php } ?>
</div>
