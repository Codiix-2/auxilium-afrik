...
<a class="print-page" href="javascript:void(0)" onclick="window.print();" aria-label="<?php esc_attr_e( 'Print', 'cariera' ); ?>"><i class="las la-print"></i><?php esc_html_e( 'Print Company', 'cariera' ); ?></a>