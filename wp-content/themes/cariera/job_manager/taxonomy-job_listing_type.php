<?php
/**
 * Custom: Taxonomy Template - Job Listing Type
 *
 * This template can be overridden by copying it to yourtheme/job_manager/taxonomy-job_listing_type.php.
 *
...
$term            = get_query_var( 'job_listing_type' );
...
<main class="cariera-section-padding">
	<div class="container">
		<?php
		if ( isset( $term ) ) {
			$shortcode = '[jobs job_types=' . $term . ' ' . $taxonomy_layout . ']';
