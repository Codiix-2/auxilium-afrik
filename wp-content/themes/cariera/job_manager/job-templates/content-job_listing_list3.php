<?php
/**
 * Custom: Job Listing - List Version 3
 *
 * This template can be overridden by copying it to yourtheme/job_manager/job-template/content-job_listing_list3.php.
 *
	...
	<div class="job-content-wrapper">
		...
		<div class="listing-body">
			...
			<div class="job-actions">
				...
				<a href="#quickview" class="job-quickview" data-id="<?php echo esc_attr( $job_id ); ?>" aria-label="<?php esc_attr_e( 'Job listing quick view action', 'cariera' ); ?>"><i class="lar la-eye"></i></a>
