...
$slider_classes = [ 'single-job-slider-item' ];
...
<div class="<?php echo esc_attr( join( ' ', $slider_classes ) ); ?>">
	...
	<div class="job-info">
		...
		<div class="job-meta">
			<span class="company-name"><i class="lar la-building"></i><?php the_company_name(); ?></span>
			<span class="location"><i class="las la-map-marker"></i><?php the_job_location(); ?></span>
		</div>
