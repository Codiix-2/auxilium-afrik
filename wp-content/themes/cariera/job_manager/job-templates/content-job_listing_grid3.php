<?php
/**
 * Custom: Job Listing - Grid Version 3
 *
 * This template can be overridden by copying it to yourtheme/job_manager/job-template/content-job_listing_grid3.php.
 *
...
$job_class = 'job-grid single_job_listing_3';
		...
		<div class="job-content-footer">
			<div class="job-details">
				...
				if ( $rate_min ) {
					...
					?>
					<div class="rate">
						<h3 class="title"><?php esc_html_e( 'Rate', 'cariera' ); ?></h3>
				...
				if ( $salary_min ) {
					...
					?>
					<div class="salary">
						<h3 class="title"><?php esc_html_e( 'Salary', 'cariera' ); ?></h3>
