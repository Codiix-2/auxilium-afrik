...
$job_class = 'job-grid single_job_listing_4';
	...
	<a href="<?php the_permalink(); ?>">
		...
		<div class="job-info-wrapper">
			...
			<div class="job-info">
				...
				<ul>
					<li class="location"><i class="las la-map-marker"></i><?php the_job_location( false ); ?></li>
					...
					if ( empty( get_post_meta( $post->ID, '_salary_min', true ) ) ) {
						if ( get_post_meta( $post->ID, '_rate_min', true ) ) {
							?>
							<li class="rate"><i class="las la-money-bill"></i><?php cariera_job_rate(); ?></li>
							<?php
						}
					}
					?>
		...
		<div class="job-extras">
			...
			$job_types_text = ! empty( $job_types ) ? implode( ', ', $job_types ) : esc_html__( 'No job type', 'cariera' );
			?>

			<div class="job-type-icon"></div>
			<span class="job-types"><?php echo esc_html( $job_types_text ); ?></span>
		</div>
	</a>
</li>
