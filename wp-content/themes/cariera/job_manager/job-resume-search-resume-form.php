...
<form method="GET" action="<?php echo esc_url( get_permalink( get_option( 'resume_manager_resumes_page_id' ) ) ); ?>" class="listing-search-form resume-search-form">
	...
	<div class="search-location">
		...
		<input type="text" id="search_location_resumes" name="search_location" placeholder="<?php esc_attr_e( 'Location', 'cariera' ); ?>" autocomplete="off">
	...
	<div class="search-submit">
		<label for="search-resumes"><?php esc_html_e( 'Button', 'cariera' ); ?></label>
		<input type="submit" id="search-resumes" class="btn btn-main btn-effect" value="<?php esc_attr_e( 'Search', 'cariera' ); ?>">
	</div>
</form>
