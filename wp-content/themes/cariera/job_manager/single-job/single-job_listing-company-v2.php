<?php
/**
 * Single view Company information box - Job Listing Company Template
 *
 * Hooked into single_job_listing_start priority 30
 *
 * This template can be overridden by copying it to yourtheme/job_manager/content-single-job_listing-company-v2.php.
 *
...
<div class="company-info">
	<div class="company">
		...
		<?php the_company_name( '<h3 class="single-job-listing-company-name">', '</h3>' ); ?>
	</div>
	...
	<div class="company-details">
		...
		if ( $website ) {
			?>
			<a class="company-website" href="<?php echo esc_url( $website ); ?>" target="_blank" rel="nofollow" aria-label="<?php esc_attr_e( 'The company\'s website', 'cariera' ); ?>">
	...
	<div class="company-actions">
		<?php if ( ! empty( $company ) ) { ?>
			<a href="<?php echo esc_url( get_permalink( $company ) ); ?>" class="btn btn-main btn-effect"><?php esc_html_e( 'View Company', 'cariera' ); ?></a>
		<?php } ?>
