<?php
/**
 * Custom: Single Job Page - Private Message
 *
 * This template can be overridden by copying it to yourtheme/job_manager/single-job/private-messages.php.
 *
...
<div class="job-private-message">
	<?php if ( is_user_logged_in() ) { ?>
		<a href="#private-messages" class="popup-with-zoom-anim btn btn-main listing-btn contact-listing-btn" 
