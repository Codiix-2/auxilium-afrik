<?php
/**
 * Custom: Taxonomy Template - Job Listing Tag
 *
 * This template can be overridden by copying it to yourtheme/job_manager/taxonomy-job_listing_tag.php.
 *
...
<main class="cariera-section-padding">
	<div class="container">
		<?php
		if ( isset( $term_id ) ) {
			$shortcode = '[jobs tags=' . $term_id . ' ' . $taxonomy_layout . ']';
