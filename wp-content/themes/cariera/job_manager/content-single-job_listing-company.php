...
<div class="company-info">
	...
	<div class="job-company-info">
		...
		if ( ! empty( $company ) && 'publish' === get_post_status( $company ) ) {
			the_company_name( '<h2 class="single-job-listing-company-name"><a href="' . esc_url( get_permalink( $company ) ) . '">', '</a></h2>' );
		} else {
			the_company_name( '<h2 class="single-job-listing-company-name">', '</h2>' );
		}
		?>
