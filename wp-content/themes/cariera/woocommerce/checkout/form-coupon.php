...
<div class="woo-form-coupon">
	<?php
		 ...
		 * @since 1.0.0
		 */
		wc_print_notice( apply_filters( 'woocommerce_checkout_coupon_message', esc_html__( 'Have a coupon?', 'cariera' ) . ' <a href="#" role="button" aria-label="' . esc_attr__( 'Enter your coupon code', 'cariera' ) . '" aria-controls="woocommerce-checkout-form-coupon" aria-expanded="false" class="showcoupon">' . esc_html__( 'Click here to enter your code', 'cariera' ) . '</a>' ), 'notice' );
	?>

	<form class="checkout_coupon" method="post" style="display:none" id="woocommerce-checkout-form-coupon">
		<p class="form-row form-row-first">
		<label for="coupon_code" class="screen-reader-text"><?php esc_html_e( 'Coupon:', 'cariera' ); ?></label>
